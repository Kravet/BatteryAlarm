...
object E2eTestConstants {
    ...
    const val ENABLED_LABEL = "Battery alarm is enabled"
    const val DISABLED_LABEL = "Battery alarm is disabled"
    const val ENABLE_BUTTON = "ON"
    const val DISABLE_BUTTON = "OFF"
    const val TEST_BUTTON = "Test the sound"
